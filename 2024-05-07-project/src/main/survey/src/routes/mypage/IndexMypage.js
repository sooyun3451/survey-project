          ...
          <div className="point_change_modal">
            ...
            >
              ...
              <div className="pointRange">
                ...
                <div onClick={() => setChangePoint((changePoint += 5000))}>
                  5,000
                </div>
                <div onClick={() => setChangePoint((changePoint += 10000))}>
                  10,000
                </div>
              </div>
            </div>
          ...
          <div className="listFrame">
            ...
            <div className="list">
              <ul>
                {pointList.map((list) => (
                  <li>
                    {list.surveyTitle} - {list.surveyPerMoney}P
                  </li>
                ))}
              </ul>
            </div>
          ...
          >
            {applyList.map((list, i) => (
              <div key={i} className="applyList_mypage">
                <span
                  onClick={() => onApplyListClickHandler(i)}
                  style={{ cursor: "pointer" }}
                >
                  ▶
                </span>
                <Link
                  to={`/survey/personal/list/start/${list.surveyCode}`}
                  state={{ surveyCode: list.surveyCode }}
                  style={{
