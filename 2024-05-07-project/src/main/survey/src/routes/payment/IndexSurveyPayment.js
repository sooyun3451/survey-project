        ...
        >
          <div className="payment_info">
            ...
            <div className="payment_info_detail">
              <div className="payment_info_detail_title">설문지 제목</div>
              <div className="payment_info_detail_content">
                {state.surveyTitle}
              </div>
            </div>
            <div className="payment_info_detail">
              <div className="payment_info_detail_title">대상 수</div>
              <div className="payment_info_detail_content">
            ...
            <div className="payment_info_detail">
              <div className="payment_info_detail_title">결제 금액</div>
              <div className="payment_info_detail_content">
                {state.participantNum * state.perMoney}원
              </div>
            </div>
            <div className="payment_info_detail">
              <div className="payment_info_detail_title">총 결제 금액</div>
              <div
                className="payment_info_detail_content"
                style={{ borderBottom: "1px solid #0F3360" }}
              >
                {state.participantNum * state.perMoney}원
              </div>
            </div>
